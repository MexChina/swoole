...
class TSocket extends TTransport {
     ...
     * @var int
     */
    private $sendTimeoutUsec_ = 10000000;
     ...
     * @var int
     */
    private $recvTimeoutUsec_ = 60000000;
    ...
    public function open() {
        ...
        if ($this->persist_) {
            $this->handle_ = @pfsockopen($this->host_, $this->port_, $errno, $errstr, $this->sendTimeoutSec_ + ($this->sendTimeoutUsec_ / 1000000));
        } else {
            $this->handle_ = @fsockopen($this->host_, $this->port_, $errno, $errstr, $this->sendTimeoutSec_ + ($this->sendTimeoutUsec_ / 1000000));
        }
