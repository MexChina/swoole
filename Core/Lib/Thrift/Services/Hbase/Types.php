      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::LST) {
            ...
            {
              $elem5 = null;
              $elem5 = new \Services\Hbase\Mutation();
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::STRUCT) {
            $this->cell = new \Services\Hbase\TCell();
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::MAP) {
            ...
            {
              $key12 = '';
              $val13 = new \Services\Hbase\TCell();
        ...
        case 3:
          if ($ftype == TType::LST) {
            ...
            {
              $elem19 = null;
              $elem19 = new \Services\Hbase\TColumn();
