...
interface HbaseIf {
    ...
    public function increment(\Services\Hbase\TIncrement $increment);

    public function incrementRows($increments);

    public function deleteAllRowTs($tableName, $row, $timestamp, $attributes);

    public function scannerOpenWithScan($tableName, \Services\Hbase\TScan $scan, $attributes);
    ...
    public function append(\Services\Hbase\TAppend $append);

    public function checkAndPut($tableName, $row, $column, $value, \Services\Hbase\Mutation $mput, $attributes);
}

class HbaseClient implements \Services\Hbase\HbaseIf {
    ...
    public function send_enableTable($tableName) {
        $args = new \Services\Hbase\Hbase_enableTable_args();
    ...
    public function recv_enableTable() {
        ...
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_enableTable_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_enableTable_result();
    ...
    public function send_disableTable($tableName) {
        $args = new \Services\Hbase\Hbase_disableTable_args();
        $args->tableName = $tableName;
        $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
    ...
    public function recv_disableTable() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_disableTable_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_disableTable_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->io !== null) {
    ...
    public function send_isTableEnabled($tableName) {
        $args = new \Services\Hbase\Hbase_isTableEnabled_args();
        $args->tableName = $tableName;
        $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
    ...
    public function recv_isTableEnabled() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_isTableEnabled_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_isTableEnabled_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
    ...
    public function send_compact($tableNameOrRegionName) {
        $args = new \Services\Hbase\Hbase_compact_args();
    ...
    public function recv_compact() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_compact_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_compact_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->io !== null) {
    ...
    public function send_majorCompact($tableNameOrRegionName) {
        $args = new \Services\Hbase\Hbase_majorCompact_args();
        $args->tableNameOrRegionName = $tableNameOrRegionName;
        $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
    ...
    public function recv_majorCompact() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_majorCompact_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_majorCompact_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->io !== null) {
    ...
    public function send_getTableNames() {
        $args = new \Services\Hbase\Hbase_getTableNames_args();
        $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
    ...
    public function recv_getTableNames() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_getTableNames_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_getTableNames_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    public function send_getColumnDescriptors($tableName) {
        $args = new \Services\Hbase\Hbase_getColumnDescriptors_args();
        $args->tableName = $tableName;
        $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
    ...
    public function recv_getColumnDescriptors() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_getColumnDescriptors_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_getColumnDescriptors_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    public function send_getTableRegions($tableName) {
        $args = new \Services\Hbase\Hbase_getTableRegions_args();
        $args->tableName = $tableName;
        $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
    ...
    public function recv_getTableRegions() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_getTableRegions_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_getTableRegions_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    public function send_createTable($tableName, $columnFamilies) {
        $args = new \Services\Hbase\Hbase_createTable_args();
        $args->tableName = $tableName;
    ...
    public function recv_createTable() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_createTable_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_createTable_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->io !== null) {
    ...
    public function send_deleteTable($tableName) {
        $args = new \Services\Hbase\Hbase_deleteTable_args();
        $args->tableName = $tableName;
        $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
    ...
    public function recv_deleteTable() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_deleteTable_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_deleteTable_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->io !== null) {
    ...
    public function send_get($tableName, $row, $column, $attributes) {
        $args = new \Services\Hbase\Hbase_get_args();
        $args->tableName = $tableName;
        $args->row = $row;
        $args->column = $column;
    ...
    public function recv_get() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_get_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_get_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    public function send_getVer($tableName, $row, $column, $numVersions, $attributes) {
        $args = new \Services\Hbase\Hbase_getVer_args();
        $args->tableName = $tableName;
        $args->row = $row;
        $args->column = $column;
    ...
    public function recv_getVer() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_getVer_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_getVer_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    public function send_getVerTs($tableName, $row, $column, $timestamp, $numVersions, $attributes) {
        $args = new \Services\Hbase\Hbase_getVerTs_args();
        $args->tableName = $tableName;
        $args->row = $row;
        $args->column = $column;
    ...
    public function recv_getVerTs() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_getVerTs_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_getVerTs_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    public function send_getRow($tableName, $row, $attributes) {
        $args = new \Services\Hbase\Hbase_getRow_args();
        $args->tableName = $tableName;
        $args->row = $row;
        $args->attributes = $attributes;
        $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
    ...
    public function recv_getRow() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_getRow_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_getRow_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    public function send_getRowWithColumns($tableName, $row, $columns, $attributes) {
        $args = new \Services\Hbase\Hbase_getRowWithColumns_args();
        $args->tableName = $tableName;
        $args->row = $row;
    ...
    public function recv_getRowWithColumns() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_getRowWithColumns_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_getRowWithColumns_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    public function send_getRowTs($tableName, $row, $timestamp, $attributes) {
        $args = new \Services\Hbase\Hbase_getRowTs_args();
        $args->tableName = $tableName;
        $args->row = $row;
        $args->timestamp = $timestamp;
        $args->attributes = $attributes;
    ...
    public function recv_getRowTs() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_getRowTs_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_getRowTs_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    public function send_getRowWithColumnsTs($tableName, $row, $columns, $timestamp, $attributes) {
        $args = new \Services\Hbase\Hbase_getRowWithColumnsTs_args();
        $args->tableName = $tableName;
        $args->row = $row;
        $args->columns = $columns;
        $args->timestamp = $timestamp;
    ...
    public function recv_getRowWithColumnsTs() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_getRowWithColumnsTs_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_getRowWithColumnsTs_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    public function send_getRows($tableName, $rows, $attributes) {
        $args = new \Services\Hbase\Hbase_getRows_args();
        $args->tableName = $tableName;
        $args->rows = $rows;
        $args->attributes = $attributes;
        $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
    ...
    public function recv_getRows() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_getRows_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_getRows_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    public function send_getRowsWithColumns($tableName, $rows, $columns, $attributes) {
        $args = new \Services\Hbase\Hbase_getRowsWithColumns_args();
        $args->tableName = $tableName;
        $args->rows = $rows;
        $args->columns = $columns;
        $args->attributes = $attributes;
    ...
    public function recv_getRowsWithColumns() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_getRowsWithColumns_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_getRowsWithColumns_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    public function send_getRowsTs($tableName, $rows, $timestamp, $attributes) {
        $args = new \Services\Hbase\Hbase_getRowsTs_args();
        $args->tableName = $tableName;
        $args->rows = $rows;
        $args->timestamp = $timestamp;
        $args->attributes = $attributes;
    ...
    public function recv_getRowsTs() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_getRowsTs_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_getRowsTs_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    public function send_getRowsWithColumnsTs($tableName, $rows, $columns, $timestamp, $attributes) {
        $args = new \Services\Hbase\Hbase_getRowsWithColumnsTs_args();
        $args->tableName = $tableName;
        $args->rows = $rows;
        $args->columns = $columns;
        $args->timestamp = $timestamp;
    ...
    public function recv_getRowsWithColumnsTs() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_getRowsWithColumnsTs_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_getRowsWithColumnsTs_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    public function send_mutateRow($tableName, $row, $mutations, $attributes) {
        $args = new \Services\Hbase\Hbase_mutateRow_args();
        $args->tableName = $tableName;
        $args->row = $row;
    ...
    public function recv_mutateRow() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_mutateRow_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_mutateRow_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->io !== null) {
    ...
    public function send_mutateRowTs($tableName, $row, $mutations, $timestamp, $attributes) {
        $args = new \Services\Hbase\Hbase_mutateRowTs_args();
        $args->tableName = $tableName;
        $args->row = $row;
        $args->mutations = $mutations;
        $args->timestamp = $timestamp;
    ...
    public function recv_mutateRowTs() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_mutateRowTs_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_mutateRowTs_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->io !== null) {
    ...
    public function send_mutateRows($tableName, $rowBatches, $attributes) {
        $args = new \Services\Hbase\Hbase_mutateRows_args();
        $args->tableName = $tableName;
    ...
    public function recv_mutateRows() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_mutateRows_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_mutateRows_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->io !== null) {
    ...
    public function send_mutateRowsTs($tableName, $rowBatches, $timestamp, $attributes) {
        $args = new \Services\Hbase\Hbase_mutateRowsTs_args();
        $args->tableName = $tableName;
        $args->rowBatches = $rowBatches;
        $args->timestamp = $timestamp;
        $args->attributes = $attributes;
    ...
    public function recv_mutateRowsTs() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_mutateRowsTs_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_mutateRowsTs_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->io !== null) {
    ...
    public function send_atomicIncrement($tableName, $row, $column, $value) {
        $args = new \Services\Hbase\Hbase_atomicIncrement_args();
        $args->tableName = $tableName;
        $args->row = $row;
        $args->column = $column;
        $args->value = $value;
    ...
    public function recv_atomicIncrement() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_atomicIncrement_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_atomicIncrement_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    public function send_deleteAll($tableName, $row, $column, $attributes) {
        $args = new \Services\Hbase\Hbase_deleteAll_args();
        $args->tableName = $tableName;
        $args->row = $row;
        $args->column = $column;
        $args->attributes = $attributes;
    ...
    public function recv_deleteAll() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_deleteAll_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_deleteAll_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->io !== null) {
    ...
    public function send_deleteAllTs($tableName, $row, $column, $timestamp, $attributes) {
        $args = new \Services\Hbase\Hbase_deleteAllTs_args();
        $args->tableName = $tableName;
        $args->row = $row;
        $args->column = $column;
        $args->timestamp = $timestamp;
    ...
    public function recv_deleteAllTs() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_deleteAllTs_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_deleteAllTs_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->io !== null) {
    ...
    public function send_deleteAllRow($tableName, $row, $attributes) {
        $args = new \Services\Hbase\Hbase_deleteAllRow_args();
        $args->tableName = $tableName;
        $args->row = $row;
        $args->attributes = $attributes;
        $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
    ...
    public function recv_deleteAllRow() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_deleteAllRow_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_deleteAllRow_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->io !== null) {
    ...
    public function send_increment(\Services\Hbase\TIncrement $increment) {
        $args = new \Services\Hbase\Hbase_increment_args();
    ...
    public function recv_increment() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_increment_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_increment_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->io !== null) {
    ...
    public function send_incrementRows($increments) {
        $args = new \Services\Hbase\Hbase_incrementRows_args();
    ...
    public function recv_incrementRows() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_incrementRows_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_incrementRows_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->io !== null) {
    ...
    public function send_deleteAllRowTs($tableName, $row, $timestamp, $attributes) {
        $args = new \Services\Hbase\Hbase_deleteAllRowTs_args();
        $args->tableName = $tableName;
        $args->row = $row;
        $args->timestamp = $timestamp;
        $args->attributes = $attributes;
    ...
    public function recv_deleteAllRowTs() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_deleteAllRowTs_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_deleteAllRowTs_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->io !== null) {
    ...
    public function send_scannerOpenWithScan($tableName, \Services\Hbase\TScan $scan, $attributes) {
        $args = new \Services\Hbase\Hbase_scannerOpenWithScan_args();
        $args->tableName = $tableName;
        $args->scan = $scan;
        $args->attributes = $attributes;
        $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
    ...
    public function recv_scannerOpenWithScan() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_scannerOpenWithScan_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_scannerOpenWithScan_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    public function send_scannerOpen($tableName, $startRow, $columns, $attributes) {
        $args = new \Services\Hbase\Hbase_scannerOpen_args();
        $args->tableName = $tableName;
    ...
    public function recv_scannerOpen() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_scannerOpen_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_scannerOpen_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    public function send_scannerOpenWithStop($tableName, $startRow, $stopRow, $columns, $attributes) {
        $args = new \Services\Hbase\Hbase_scannerOpenWithStop_args();
        $args->tableName = $tableName;
        $args->startRow = $startRow;
    ...
    public function recv_scannerOpenWithStop() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_scannerOpenWithStop_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_scannerOpenWithStop_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    public function send_scannerOpenWithPrefix($tableName, $startAndPrefix, $columns, $attributes) {
        $args = new \Services\Hbase\Hbase_scannerOpenWithPrefix_args();
        $args->tableName = $tableName;
    ...
    public function recv_scannerOpenWithPrefix() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_scannerOpenWithPrefix_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_scannerOpenWithPrefix_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    public function send_scannerOpenTs($tableName, $startRow, $columns, $timestamp, $attributes) {
        $args = new \Services\Hbase\Hbase_scannerOpenTs_args();
        $args->tableName = $tableName;
        $args->startRow = $startRow;
        $args->columns = $columns;
        $args->timestamp = $timestamp;
    ...
    public function recv_scannerOpenTs() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_scannerOpenTs_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_scannerOpenTs_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    public function send_scannerOpenWithStopTs($tableName, $startRow, $stopRow, $columns, $timestamp, $attributes) {
        $args = new \Services\Hbase\Hbase_scannerOpenWithStopTs_args();
        $args->tableName = $tableName;
        $args->startRow = $startRow;
        $args->stopRow = $stopRow;
        $args->columns = $columns;
    ...
    public function recv_scannerOpenWithStopTs() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_scannerOpenWithStopTs_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_scannerOpenWithStopTs_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    public function send_scannerGet($id) {
        $args = new \Services\Hbase\Hbase_scannerGet_args();
        $args->id = $id;
        $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
    ...
    public function recv_scannerGet() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_scannerGet_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_scannerGet_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    public function send_scannerGetList($id, $nbRows) {
        $args = new \Services\Hbase\Hbase_scannerGetList_args();
        $args->id = $id;
        $args->nbRows = $nbRows;
        $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
    ...
    public function recv_scannerGetList() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_scannerGetList_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_scannerGetList_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    public function send_scannerClose($id) {
        $args = new \Services\Hbase\Hbase_scannerClose_args();
        $args->id = $id;
        $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
    ...
    public function recv_scannerClose() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_scannerClose_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_scannerClose_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->io !== null) {
    ...
    public function send_getRowOrBefore($tableName, $row, $family) {
        $args = new \Services\Hbase\Hbase_getRowOrBefore_args();
        $args->tableName = $tableName;
        $args->row = $row;
        $args->family = $family;
        $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
    ...
    public function recv_getRowOrBefore() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_getRowOrBefore_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_getRowOrBefore_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    public function send_getRegionInfo($row) {
        $args = new \Services\Hbase\Hbase_getRegionInfo_args();
        $args->row = $row;
        $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
    ...
    public function recv_getRegionInfo() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_getRegionInfo_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_getRegionInfo_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    public function send_append(\Services\Hbase\TAppend $append) {
        $args = new \Services\Hbase\Hbase_append_args();
        $args->append = $append;
        $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
    ...
    public function recv_append() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_append_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_append_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    public function send_checkAndPut($tableName, $row, $column, $value, \Services\Hbase\Mutation $mput, $attributes) {
        $args = new \Services\Hbase\Hbase_checkAndPut_args();
        $args->tableName = $tableName;
        $args->row = $row;
        $args->column = $column;
        $args->value = $value;
    ...
    public function recv_checkAndPut() {
        $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel)
            $result = thrift_protocol_read_binary($this->input_, '\Services\Hbase\Hbase_checkAndPut_result', $this->input_->isStrictRead());
        else {
            $rseqid = 0;
            $fname = null;
            $mtype = 0;
            ...
            $result = new \Services\Hbase\Hbase_checkAndPut_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
            ...
            switch ($fid) {
                case 1:
                    if ($ftype == TType::STRUCT) {
                        $this->io = new \Services\Hbase\IOError();
        ...
        if (!isset(self::$_TSPEC)) {
            self::$_TSPEC = array(
                0 => array(
                    ...
                    'val' => array(
                        'type' => TType::STRUCT,
                        'class' => '\Services\Hbase\ColumnDescriptor',
                    ),
                ),
                1 => array(
                    'var' => 'io',
                ...
                case 0:
                    if ($ftype == TType::MAP) {
                        ...
                        for ($_i55 = 0; $_i55 < $_size51; ++$_i55) {
                            $key56 = '';
                            $val57 = new \Services\Hbase\ColumnDescriptor();
        ...
        if (!isset(self::$_TSPEC)) {
            self::$_TSPEC = array(
                0 => array(
                    ...
                    'elem' => array(
                        'type' => TType::STRUCT,
                        'class' => '\Services\Hbase\TRegionInfo',
                    ),
                ),
                1 => array(
                    'var' => 'io',
                ...
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i64 = 0; $_i64 < $_size60; ++$_i64) {
                            $elem65 = null;
                            $elem65 = new \Services\Hbase\TRegionInfo();
                ...
                case 2:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i71 = 0; $_i71 < $_size67; ++$_i71) {
                            $elem72 = null;
                            $elem72 = new \Services\Hbase\ColumnDescriptor();
        ...
        if (!isset(self::$_TSPEC)) {
            self::$_TSPEC = array(
                ...
                2 => array(
                    'var' => 'ia',
                    'type' => TType::STRUCT,
                    'class' => '\Services\Hbase\IllegalArgument',
                ),
                3 => array(
                    'var' => 'exist',
                    'type' => TType::STRUCT,
                    'class' => '\Services\Hbase\AlreadyExists',
                ),
            );
        }
        if (is_array($vals)) {
    ...
    public function read($input) {
        ...
        while (true) {
            ...
            switch ($fid) {
                ...
                case 2:
                    if ($ftype == TType::STRUCT) {
                        $this->ia = new \Services\Hbase\IllegalArgument();
                ...
                case 3:
                    if ($ftype == TType::STRUCT) {
                        $this->exist = new \Services\Hbase\AlreadyExists();
                ...
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i87 = 0; $_i87 < $_size83; ++$_i87) {
                            $elem88 = null;
                            $elem88 = new \Services\Hbase\TCell();
                ...
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i103 = 0; $_i103 < $_size99; ++$_i103) {
                            $elem104 = null;
                            $elem104 = new \Services\Hbase\TCell();
                ...
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i119 = 0; $_i119 < $_size115; ++$_i119) {
                            $elem120 = null;
                            $elem120 = new \Services\Hbase\TCell();
        ...
        if (!isset(self::$_TSPEC)) {
            self::$_TSPEC = array(
                0 => array(
                    ...
                    'elem' => array(
                        'type' => TType::STRUCT,
                        'class' => '\Services\Hbase\TRowResult',
                    ),
                ),
                1 => array(
                    'var' => 'io',
                ...
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i135 = 0; $_i135 < $_size131; ++$_i135) {
                            $elem136 = null;
                            $elem136 = new \Services\Hbase\TRowResult();
                ...
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i158 = 0; $_i158 < $_size154; ++$_i158) {
                            $elem159 = null;
                            $elem159 = new \Services\Hbase\TRowResult();
                ...
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i174 = 0; $_i174 < $_size170; ++$_i174) {
                            $elem175 = null;
                            $elem175 = new \Services\Hbase\TRowResult();
                ...
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i197 = 0; $_i197 < $_size193; ++$_i197) {
                            $elem198 = null;
                            $elem198 = new \Services\Hbase\TRowResult();
                ...
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i220 = 0; $_i220 < $_size216; ++$_i220) {
                            $elem221 = null;
                            $elem221 = new \Services\Hbase\TRowResult();
                ...
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i250 = 0; $_i250 < $_size246; ++$_i250) {
                            $elem251 = null;
                            $elem251 = new \Services\Hbase\TRowResult();
                ...
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i273 = 0; $_i273 < $_size269; ++$_i273) {
                            $elem274 = null;
                            $elem274 = new \Services\Hbase\TRowResult();
                ...
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i303 = 0; $_i303 < $_size299; ++$_i303) {
                            $elem304 = null;
                            $elem304 = new \Services\Hbase\TRowResult();
                ...
                case 3:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i310 = 0; $_i310 < $_size306; ++$_i310) {
                            $elem311 = null;
                            $elem311 = new \Services\Hbase\Mutation();
                ...
                case 3:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i326 = 0; $_i326 < $_size322; ++$_i326) {
                            $elem327 = null;
                            $elem327 = new \Services\Hbase\Mutation();
        ...
        if (!isset(self::$_TSPEC)) {
            self::$_TSPEC = array(
                ...
                2 => array(
                    ...
                    'elem' => array(
                        'type' => TType::STRUCT,
                        'class' => '\Services\Hbase\BatchMutation',
                    ),
                ),
                3 => array(
                    'var' => 'attributes',
                ...
                case 2:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i342 = 0; $_i342 < $_size338; ++$_i342) {
                            $elem343 = null;
                            $elem343 = new \Services\Hbase\BatchMutation();
                ...
                case 2:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i358 = 0; $_i358 < $_size354; ++$_i358) {
                            $elem359 = null;
                            $elem359 = new \Services\Hbase\BatchMutation();
        ...
        if (!isset(self::$_TSPEC)) {
            self::$_TSPEC = array(
                1 => array(
                    'var' => 'increment',
                    'type' => TType::STRUCT,
                    'class' => '\Services\Hbase\TIncrement',
                ),
            );
        }
        if (is_array($vals)) {
    ...
    public function read($input) {
        ...
        while (true) {
            ...
            switch ($fid) {
                case 1:
                    if ($ftype == TType::STRUCT) {
                        $this->increment = new \Services\Hbase\TIncrement();
                ...
                case 1:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i401 = 0; $_i401 < $_size397; ++$_i401) {
                            $elem402 = null;
                            $elem402 = new \Services\Hbase\TIncrement();
    ...
    public function read($input) {
        ...
        while (true) {
            ...
            switch ($fid) {
                ...
                case 2:
                    if ($ftype == TType::STRUCT) {
                        $this->scan = new \Services\Hbase\TScan();
                ...
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i506 = 0; $_i506 < $_size502; ++$_i506) {
                            $elem507 = null;
                            $elem507 = new \Services\Hbase\TRowResult();
                ...
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i513 = 0; $_i513 < $_size509; ++$_i513) {
                            $elem514 = null;
                            $elem514 = new \Services\Hbase\TRowResult();
                ...
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i520 = 0; $_i520 < $_size516; ++$_i520) {
                            $elem521 = null;
                            $elem521 = new \Services\Hbase\TCell();
    ...
    public function read($input) {
        ...
        while (true) {
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::STRUCT) {
                        $this->success = new \Services\Hbase\TRegionInfo();
    ...
    public function read($input) {
        ...
        while (true) {
            ...
            switch ($fid) {
                case 1:
                    if ($ftype == TType::STRUCT) {
                        $this->append = new \Services\Hbase\TAppend();
                ...
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i527 = 0; $_i527 < $_size523; ++$_i527) {
                            $elem528 = null;
                            $elem528 = new \Services\Hbase\TCell();
    ...
    public function read($input) {
        ...
        while (true) {
            ...
            switch ($fid) {
                ...
                case 6:
                    if ($ftype == TType::STRUCT) {
                        $this->mput = new \Services\Hbase\Mutation();
