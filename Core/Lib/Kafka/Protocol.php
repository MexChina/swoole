...
namespace Swoole\Core\Lib\Kafka;
use Swoole\Core\Lib\Kafka\Protocol\Protocol as PProtocol;
use \Exception;
/**
+------------------------------------------------------------------------------
...
class Protocol
{
    ...
    {
        $class = array(
            PProtocol::PRODUCE_REQUEST => 'Produce',
            PProtocol::FETCH_REQUEST => 'Fetch',
            PProtocol::OFFSET_REQUEST => 'Offset',
            PProtocol::METADATA_REQUEST => 'Metadata',
            PProtocol::OFFSET_COMMIT_REQUEST => 'CommitOffset',
            PProtocol::OFFSET_FETCH_REQUEST => 'FetchOffset',
            PProtocol::GROUP_COORDINATOR_REQUEST => 'GroupCoordinator',
            PProtocol::JOIN_GROUP_REQUEST => 'JoinGroup',
            PProtocol::HEART_BEAT_REQUEST => 'Heartbeat',
            PProtocol::LEAVE_GROUP_REQUEST => 'LeaveGroup',
            PProtocol::SYNC_GROUP_REQUEST => 'SyncGroup',
            PProtocol::DESCRIBE_GROUPS_REQUEST => 'DescribeGroups',
            PProtocol::LIST_GROUPS_REQUEST => 'ListGroup',
        );

        $namespace = 'Swoole\\Core\\Lib\\Kafka\\Protocol\\';
